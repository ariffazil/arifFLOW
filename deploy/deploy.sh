...
TARGET_DIR="/opt/ariflow"
SERVICE_NAME="ariflow.service"
...
cp target/release/ariflow "${TARGET_DIR}/ariflow"
chmod +x "${TARGET_DIR}/ariflow"
...
echo "Health: curl http://127.0.0.1:7075/health"
